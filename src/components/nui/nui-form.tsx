    ...
    <form action={formAction} className="flex flex-col gap-4 rounded-xl border border-line bg-white p-5">
      ...
      <fieldset className="flex flex-col gap-3 rounded-lg bg-ground/60 p-3">
        ...
        <p className="text-[11px] leading-4 text-muted-foreground">
          作品の内寸と比べて「入るかどうか」を判定します。座高からサイズ区分（10 / 15 / 20cm）も決まります。
        </p>

        <div className="flex flex-col gap-1.5">
          <Label htmlFor="sitHeightMm">座高（必須）</Label>
          <Input
            id="sitHeightMm"
            name="sitHeightMm"
            type="number"
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <p className="text-[10.5px] text-muted-foreground">
            腕を含めた一番広いところ。未入力の項目は相性判定で「判定できません」になります
          </p>
        </div>
      </fieldset>
