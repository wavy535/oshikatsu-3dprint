...
import { AR_ANCHOR, AR_BLEND, AR_CALIBRATION, AR_LIMITS, AR_MATERIALS, AR_MODEL, AR_ROOM } from "./config.ts";
...
export function modelRevision() {
  return revisionOf(
    JSON.stringify([AR_MODEL, AR_ROOM, AR_MATERIALS, AR_CALIBRATION, AR_LIMITS, AR_BLEND, AR_ANCHOR, NUI_PROPORTIONS]),
  );
}
