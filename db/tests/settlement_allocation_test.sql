...
select set_config('app.user_id', '14000000-0000-4000-8000-000000000003', true), set_config('app.role', 'app_user', true);
...
select set_config('app.user_id', '14000000-0000-4000-8000-000000000004', true), set_config('app.role', 'app_user', true);
select is((select count(*) from public.order_item_settlement_amounts('24000000-0000-4000-8000-000000000001')),
  0::bigint, 'unrelated users cannot read allocations');
select set_config('app.user_id', '14000000-0000-4000-8000-000000000001', true), set_config('app.role', 'app_user', true);
select is((select count(*) from public.order_item_settlement_amounts('24000000-0000-4000-8000-000000000001')),
