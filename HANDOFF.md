...
> この表は案Bを引き継いだ 2026-09-07 時点のものです。**いまの実装状況は `docs/引き継ぎ_実装_2026-09-08.md` と README §13** を見てください（決済〜払込、運営コンソール、クリエイター申請の SMS 認証まで実装済み）。ここで残す価値があるのは 3 節の設計判断と 4 節以降のハマりどころです。
